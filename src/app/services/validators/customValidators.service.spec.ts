...
@Component({
  ...
  <input type="email" id="email" formGroupName="email" name="email"/>
    <input type="password" id="password"  formGroupName="password" name="password"/>
    <input type="password" id="confirmPassword"  formGroupName="confirmPassword" name="confirmPassword" />
